      ...
      <div class="container mx-auto px-4">
        ...
        >
          <nav
            ...
            :class="{'sm:text-center': index === 1, 'sm:text-right': index === 2}"
          >
            <h3
            ...
            >
              <li v-for="(link, i) in l" :key="i" class="py-2">
                ...
                >{{ link.key }}</a>
                <NuxtLink v-else :to="link.to" class="hover:text-nuxt-lightgreen">{{ link.key }}</NuxtLink>
              </li>
            </ul>
          </nav>
        </div>
      ...
      >
        ...
        >
          ...
          <div class="flex-1 text-right">
            <AppLangSelect :value="$i18n.locale" :options="$i18n.locales" label="Select language">
