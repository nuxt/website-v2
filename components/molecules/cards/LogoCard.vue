<template>
  <div class="ListCard group">
    ...
    <nuxt-img
      class="ListCard-external group-hover:opacity-100"
      alt="external_link"
      src="/img/icons/ext.svg"
      width="24"
      height="24"
    />
...
.ListCard-external {
  @apply transition-opacity duration-200 opacity-0 absolute top-4 right-4 cursor-pointer;
}
</style>
