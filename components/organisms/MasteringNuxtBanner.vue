<template>
  <div class="bg-surface dark:bg-surface">
    <div class="container mx-auto px-4 py-2 sm:px-6 lg:px-6 lg:py-4">
      <div
        class="flex items-center justify-between font-medium text-xs md:text-sm lg:text-base text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary"
      >
