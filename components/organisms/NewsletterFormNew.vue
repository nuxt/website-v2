      ...
      <form class="flex" data-cy="newsletter" @submit.prevent="subscribe">
        <div class="w-56 md:w-5/12 xl:w-full">
          ...
          <input
            ...
            class="border border-r-0 w-full w-48 bg-light-elevatedSurface text-light-onSurfacePrimary rounded py-3 px-4 font-medium rounded-r-none outline-none focus:border-primary-base"
        ...
        <input
          ...
          "
          name="subscribe"
          class="cursor-pointer inline-block bg-primary-base text-white font-medium text-sm px-4 lg:px-5 py-2 shadow uppercase rounded rounded-l-none hover:bg-primary-light hover:shadow-md text-base"
