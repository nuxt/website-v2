<template>
  <section class="relative light:bg-gray-50 pt-20 dark:bg-secondary-darkest">
    <NuxtContainer class="flex flex-col items-center">
      <div class="flex flex-col w-full items-center col-span-12">
        ...
        <p class="font-normal text-center text-body-base md:text-body-lg 2xl:text-body-xl mb-4 md:mb-12">
          <Markdown use="description" unwrap="p" />
        </p>

        <div class="w-full md:my-8">
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-20 pb-8">
            <slot />
          </div>
        </div>
      </div>
