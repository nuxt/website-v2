<template>
  <div class="algolia-search">
    ...
    <ContentSearchInput class="hidden md:inline-block align-middle" appearance="main" />
    <div v-if="showMobile" class="mobile-search flex items-center absolute inset-0 w-full h-full md:hidden z-20">
      ...
      <ContentSearchInput class="md:inline-block w-full align-middle mx-4" :class="[showMobile && 'absolute z-20 inset-0']" appearance="mobile" @close-search="showMobile = false" />
    </div>
  </div>
</template>
