      ...
      <client-only>
        <form class="flex flex-row justify-center mb-2" @submit.prevent="subscribe">
          <div>
            ...
            <input id="news-email" v-model="email" type="email" required :placeholder="formWordings.email" class="border border-r-0 w-48 md:w-64 bg-light-elevatedSurface text-light-onSurfacePrimary rounded py-3 px-4 font-medium rounded-r-none outline-none focus:border-primary-base shadow-inner">
          </div>
