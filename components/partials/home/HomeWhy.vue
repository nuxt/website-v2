      ...
      <section class="rounded py-6 sm:p-6">
        ...
        <div class="flex flex-col lg:flex-row items-start justify-between">
          <div class="lg:w-1/3 px-4 py-8 lg:p-8 flex flex-col items-center">
            ...
            <h4 class="uppercase font-medium text-2xl py-8">{{ $t('homepage.why.modular.title') }}</h4>
            <p
          ...
          <div class="lg:w-1/3 px-4 py-8 lg:p-8 flex flex-col items-center">
            ...
            <h4
              class="uppercase font-medium text-2xl py-8"
            >{{ $t('homepage.why.performant.title') }}</h4>
            <p
              class="leading-loose text-light-onSurfaceSecondary dark:text-dark-onSurfaceSecondary"
          ...
          <div class="lg:w-1/3 px-4 py-8 lg:p-8 flex flex-col items-center">
            ...
            <h4 class="uppercase font-medium text-2xl py-8">{{ $t('homepage.why.enjoyable.title') }}</h4>
            <p
              class="leading-loose text-light-onSurfaceSecondary dark:text-dark-onSurfaceSecondary"
        ...
        <div class="text-center">
          <AppButton href="https://template.nuxtjs.org" class="py-3 px-6 text-base">
            <svg
              slot="icon"
