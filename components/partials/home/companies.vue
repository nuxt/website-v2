        ...
        <div class="flex flex-col lg:flex-row items-center justify-between">
          <div v-for="(company, i) in langCompanies.slice(0, 5)" :key="i" class="p-4 lg:p-8 text-center">
            <a :href="company.url" target="_blank" rel="noopener nofollow" class="company relative block">
              <!-- <ClientOnly> -->
              <img :src="`/img/companies/preview/${$colorMode.value}/${company.img}`" :alt="company.name" class="preview" :class="company.class">
              <img :src="`/img/companies/original/${company.img}`" :alt="company.name" class="original absolute top-0 left-0" :class="company.class">
              <!-- </ClientOnly> -->
            </a>
          </div>
        </div>
    ...
    return {
      companies: {
        en: [
          ...
          { name: 'GitLab', img: 'gitlab.svg', url: 'https://design.gitlab.com', class: 'h-12' },
          { name: 'Nespresso', img: 'nespresso.svg', url: 'https://www.nespresso.com/careers/', class: 'h-8' },
          ...
          { name: 'BackMarket', img: 'backmarket.svg', url: 'https://www.backmarket.com', class: 'h-6' }
        ],
        fr: [
          { name: 'Ubisoft', img: 'ubisoft.svg', url: 'https://assassinscreed.ubisoft.com/story-creator-mode', class: 'h-12' },
          { name: 'Maisons du monde', img: 'maisons-du-monde.svg', url: 'https://www.maisonsdumonde.com/', class: 'h-12' },
          { name: 'BackMarket', img: 'backmarket.svg', url: 'https://www.backmarket.fr', class: 'h-6' },
          { name: 'Faire', img: 'faire.svg', url: 'https://www.faire.fr', class: 'h-16' },
          { name: 'Roland Garros', img: 'roland-garros.svg', url: 'https://www.rolandgarros.com', class: 'h-16' },
        ...
        ja: [
          { name: 'Rakuten', img: 'rakuten.svg', url: 'https://biccamera.rakuten.co.jp', class: 'h-10' },
