    ...
    <section class="bg-elevatedSurfaceColor rounded py-6 sm:p-6">
      ...
      <div class="flex flex-col lg:flex-row items-start justify-between">
        <div class="lg:w-1/3 px-4 py-8 lg:p-8 flex flex-col items-center">
          ...
          <p class="leading-loose text-onSurfaceSecondary" v-html="wordings.why_modular.body" />
        </div>
        <div class="lg:w-1/3 px-4 py-8 lg:p-8 flex flex-col items-center">
          ...
          <p class="leading-loose text-onSurfaceSecondary" v-html="wordings.why_performant.body" />
        </div>
        <div class="lg:w-1/3 px-4 py-8 lg:p-8 flex flex-col items-center">
          ...
          <p class="leading-loose text-onSurfaceSecondary" v-html="wordings.why_enjoyable.body" />
        </div>
      </div>
