<template>
  <AppPage class="min-h-screen-sm relative z-0 h-full mb-4 sm:mb-8 lg:mb-20">
    <div class="relative flex flex-col items-center justify-center px-4 mt-48 md:px-0 z-10">
      ...
      <SectionButton to="/" size="md" class="text-gray-800 bg-primary hover:bg-primary-400 focus:bg-primary-400">
        {{ $t('common.go_home') }}
      </SectionButton>
    </div>
    <NuxtImg
