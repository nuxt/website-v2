...
Response from the Node.js server. If Nuxt is used as a middleware, the res object might be different depending on the framework you're using.<br>**Not available with [static target](/docs/2.x/x/features/deployment-targets#static-hosting)**.
