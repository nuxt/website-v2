...
_ℹ️ These features are all available with [v2.8.0 release](https://github.com/nuxt/nuxt/releases/tag/v2.8.0)._
...
- Documentation: [https://v2.nuxt.com](https://v2.nuxt.com)
