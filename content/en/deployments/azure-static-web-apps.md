...
::alert{type="info"}
<b>New:</b> You can now also deploy universally rendered Nuxt 3 sites on Azure Static Web Apps, read the [documentation here](https://nitro.unjs.io/deploy/providers/azure#azure-static-web-apps).
::
