...
- If you use 17+ Node Version is common to break into `0308010C:digital envelope routines::unsupported` error, this is a common issue and you can solve it by using node 16, we recommend to use nvm to manage Node versions
```bash
nvm install 16
