...
If you have a any of the following files in your project root directory, they will be automatically loaded into `process.env` and accessible within your `nuxt.config`/`serverMiddleware` and any other files they import.
