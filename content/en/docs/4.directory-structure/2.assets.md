...
description: The assets directory contains your un-compiled assets such as Styles or Sass files, images, or fonts.
...
The `assets` directory contains your un-compiled assets such as Styles or Sass files, images, or fonts.
