...
This allows you to create a client api - server api pattern using nuxt alone. This means that you can use your client-side (e.g., a component) to call the api routes in your server middleware, i.e., your server-side routes. 
