...
<base-alert type="warning">**Warning**: not all dependencies are guaranteed to be bundled (for example, if there are dynamic imports in a 3rd-party module), so this is for advanced users only.</base-alert>
