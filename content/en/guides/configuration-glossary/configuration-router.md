...
Globally configure [`<nuxt-link>`](/docs/2.x/x/features/nuxt-components#the-nuxtlink-component) default active class.
...
Globally configure [`<nuxt-link>`](/docs/2.x/x/features/nuxt-components#the-nuxtlink-component) default exact active class.
...
Globally configure [`<nuxt-link>`](/docs/2.x/x/features/nuxt-components#the-nuxtlink-component) default prefetch class (feature disabled by default)
...
To learn more about the middleware, see the [middleware guide](/docs/2.x/x/directory-structure/middleware#router-middleware).
...
> Added with v2.13.0, only available for [static target](/docs/2.x/x/features/deployment-targets#static-hosting).
