...
To add external fonts such as google fonts check out the [Meta Tags and SEO chapter](/docs/2.x/x/features/meta-tags-seo#external-resources)
...
If you want to change the loader configurations, please use [build.extend](/docs/2.x/x/configuration-glossary/configuration-build#extend).
