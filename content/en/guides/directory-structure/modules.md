...
There are way more hooks and possibilities for modules. Please read the [Nuxt Internals](/docs/2.x/x/internals-glossary/internals) to find out more about the nuxt-internal API.
