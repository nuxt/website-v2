...
See more on how fetch works in our [Data Fetching](/docs/2.x/x/features/data-fetching) chapter
...
See more in our [Meta Tags and SEO](/docs/2.x/x/features/meta-tags-seo) chapter
...
See more on layouts in our [Views](/docs/2.x/x/concepts/views#layouts) chapter.
...
See more in our [Loading](/docs/2.x/x/features/loading) chapter.
...
See more on transitions in our [Transitions](/docs/2.x/x/features/transitions) chapter
...
If you want to overwrite the default scroll behavior of Nuxt.js, take a look at the [scrollBehavior option](/docs/2.x/x/configuration-glossary/configuration-router#scrollbehavior).
...
See more on middleware in our [Middleware](/docs/2.x/x/directory-structure/middleware) chapter
...
See more on the watch query property in our [Data Fetching](/docs/2.x/x/features/data-fetching) chapter
...
Checkout the [ignore option](/docs/2.x/x/configuration-glossary/configuration-ignore) to learn more about it.
...
Checkout the [dir option](/docs/2.x/x/configuration-glossary/configuration-dir) to learn more about it.
