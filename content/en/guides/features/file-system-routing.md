...
[Generate dynamic routes](/docs/2.x/x/concepts/static-site-generation) for static sites
...
Don't forget to include the [NuxtChild component](/docs/2.x/x/features/nuxt-components#the-nuxtchild-component) inside the parent component (`.vue` file).
...
- Use the [router.extendRoutes](/docs/2.x/x/configuration-glossary/configuration-router#extendroutes) property in your `nuxt.config.js`
...
[Router Base Property](/docs/2.x/x/configuration-glossary/configuration-router#base)
...
[extendRoutes Property](/docs/2.x/x/configuration-glossary/configuration-router#extendroutes)
...
[fallback Property](/docs/2.x/x/configuration-glossary/configuration-router#fallback)
...
[mode Property](/docs/2.x/x/configuration-glossary/configuration-router#mode)
...
[scrollBehavior Property](/docs/2.x/x/configuration-glossary/configuration-router#scrollbehavior)
...
[trailingSlash Property](/docs/2.x/x/configuration-glossary/configuration-router#trailingslash)
