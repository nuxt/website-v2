...
**Warning:** dynamic routes are ignored by the `generate` command when using Nuxt <= v2.12: [API Configuration generate](/docs/2.x/x/configuration-glossary/configuration-generate)

</base-alert>

<base-alert type="info">

When generating your web application with `nuxt generate`, [the context](/docs/2.x/x/internals-glossary/context) given to [asyncDat(/docs/2.x/2.x/features/data-fetching#async-data) and [fe(/docs/2.x/s/2.x/features/data-fetching#the-fetch-hook) will not have `req` and `res`.
