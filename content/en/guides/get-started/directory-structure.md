...
Learn more about the [components directory](/docs/2.x/x/directory-structure/components)
...
Learn more about the [assets directory](/docs/2.x/x/directory-structure/assets)
...
Learn more about the [static directory](/docs/2.x/x/directory-structure/static)
...
Learn more about the [nuxt.config.js file](/docs/2.x/x/directory-structure/nuxt-config)
