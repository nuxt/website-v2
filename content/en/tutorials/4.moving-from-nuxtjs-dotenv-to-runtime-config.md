...
export default {
  publicRuntimeConfig: {
    baseURL: process.env.NODE_ENV === 'production' ? 'https://v2.nuxt.com' : 'https://dev-v2.nuxt.com'
  }
}
```
...
::list{type="success"}
- Use default values for runtimeConfig such as process.env.baseURL || 'https://v2.nuxt.com'
::
