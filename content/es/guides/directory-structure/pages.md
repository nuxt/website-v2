...
Conoce más sobre cómo `fetch` funciona en nuestro capítulo de [Data Fetching](/docs/2.x/x/features/data-fetching)
...
Conoce mas en nuestro capítulo de [Meta Tags y SEO](/docs/2.x/x/features/meta-tags-seo).
...
Conoce mas en nuestro capítulo de [Vistas](/docs/2.x/x/concepts/views#layouts).
...
Conoce más sobre esto en el capítulo de [Loading](/docs/2.x/x/features/loading).
...
Conoce más sobre transiciones en el capítulo de [Transiciones](/docs/2.x/x/features/transitions).
...
Si quieres sobre escribir el comportamiento de desplazamiento (scroll) de Nuxt.js, puedes navegar a [opción de scrollBehavior](/docs/2.x/x/configuration-glossary/configuration-router#scrollbehavior)
...
Conoce más sobre este tema en el capítulo de [Middleware](/docs/2.x/x/directory-structure/middleware).
...
Conóce mas sobre usar datos desde un API en este capítulo [Data Fetching](/docs/2.x/x/features/data-fetching).
...
Conóce mas sobre éste tema en el siguiente enlace: [ignore option](/docs/2.x/x/configuration-glossary/configuration-ignore).
...
Conoce más sobre esto en el siguiente enlace: [dir option](/docs/2.x/x/configuration-glossary/configuration-dir).
