...
Vous pouvez jouer en ligne avec Nuxt sur CodeSandbox ou StackBlitz:

:button-link[Play on CodeSandbox]{.mb-2 .sm:mb-0 href=https://codesandbox.io/s/github/nuxt/codesandbox-nuxt/tree/master/ blank}
