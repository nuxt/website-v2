...
Lorsque l'on ajoute les routes qui utilisent des [routes nommées](https://v2.nuxt.com/guide/routing#named-views), il ne faut pas oublier d'ajouter les `chunkNames` des `components`.
