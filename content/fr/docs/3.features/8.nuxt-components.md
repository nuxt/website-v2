...
Pour voir un exemple, on peut regarder celui sur les [routes imbriquées](https://v2.nuxt.com/examples/nested-routes).
...
<template>
  <div>
    ...
    <a href="https://v2.nuxt.com">Lien externe vers une autre page</a>
  </div>
</template>
```
