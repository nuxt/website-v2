...
::alert{type="warning"}
Les routes dynamiques seront ignorés par la commande `generate` lors de l'utilisation d'une version de Nuxt inférieure à `2.12`.
::
