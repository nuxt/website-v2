...
Untuk menambahkan fon eksternal seperti fon google, lihat [bab Tag Meta dan SEO](/docs/2.x/x/features/meta-tags-seo#external-resources)
...
Jika Anda ingin mengubah konfigurasi pada pemuat tersebut, gunakan [build.extend](/docs/2.x/x/configuration-glossary/configuration-build#extend).
