...
Lihat lebih lanjut bagaimana _fetch_ bekerja pada bab [Data Fetching](/docs/2.x/x/features/data-fetching)
...
Lihat lebih lanjut pada bab [Meta Tags dan SEO](/docs/2.x/x/features/meta-tags-seo).
...
Lihat lebih lanjut mengenai _layouts_ pada bab [Views](/docs/2.x/x/concepts/views#layouts).
...
Lihat lebih lanjut pada bab [Loading](/docs/2.x/x/features/loading).
...
Lihat lebih lanjut pada bab [Transitions](/docs/2.x/x/features/transitions).
...
Jika Anda ingin menimpa tingkah pengguliran secara bawaan dari Nuxt.js, silahkan melihat pada [scrollBehavior Option](/docs/2.x/x/configuration-glossary/configuration-router#scrollbehavior).
...
Lihat lebih lanjut pada bab [Middleware](/docs/2.x/x/directory-structure/middleware).
...
Lihat lebih lanjut mengenai properti _watch query_ pada bab [Data Fetching](/docs/2.x/x/features/data-fetching).
...
Lihat [ignore option](/docs/2.x/x/configuration-glossary/configuration-ignore) untuk mempelajari lebih lanjut.
...
Lihat [dir option](/docs/2.x/x/configuration-glossary/configuration-dir) untuk mempelajari lebih lanjut.
