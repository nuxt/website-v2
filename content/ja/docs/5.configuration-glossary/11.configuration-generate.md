...
<<<<<<< HEAD:content/ja/docs/5.configuration-glossary/11.configuration-generate.md
...
>>>>>>> 32390dfa (fix: missing URLs and release-notes):content/ja/guides/configuration-glossary/configuration-generate.md
