...
SPA を実行した場合は他のルートが生成されず必要はファイルは `200.html` のみとなるので、`200.html` を使うのが慣習的です。
...
- **非推奨です！**
- 代わりに [build.html.minify](/docs/2.x/x/configuration-glossary/configuration-build#htmlminify) を使ってください
