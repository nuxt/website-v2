...
静的なサイトのために [動的なルーティングを生成する](/docs/2.x/x/concepts/static-site-generation)
...
親コンポーネント （`.vue` ファイル）内に [NuxtChild  コンポーネント](/docs/2.x/x/features/nuxt-components#the-nuxtchild-component)を含めることを忘れないでください。
...
- `nuxt.config.js` 内で [router.extendRoutes](/docs/2.x/x/configuration-glossary/configuration-router#extendroutes)  プロパティを使う
...
[Router Base プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#base)
...
[extendRoutes プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#extendroutes)
...
[fallback プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#fallback)
...
[mode プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#mode)
...
[parseQuery / stringifyQuery プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#parsequery--stringifyquery)
...
[scrollBehavior プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#scrollbehavior)
...
[trailingSlash プロパティ](/docs/2.x/x/configuration-glossary/configuration-router#trailingslash)
