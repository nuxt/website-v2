...
[components ディレクトリ](/docs/2.x/x/directory-structure/components)についてより理解する
...
[assets ディレクトリ](/docs/2.x/x/directory-structure/assets)についてより理解する
...
[static ディレクトリ](/docs/2.x/x/directory-structure/static)についてより理解する
...
[nuxt.config.js ファイル](/docs/2.x/x/directory-structure/nuxt-config)についてより理解する
...
すべてのディレクトリについての詳細は[ディレクトリ構造のドキュメント](/docs/2.x/x/directory-structure/nuxt)を参照してください。
