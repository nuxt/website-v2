...
Abaixo está um exemplo de configuação. Mantenha em mente que:
...
- se seu site é majoritariamente estático, aumente os números do `proxy_cache_path_inactive` e `proxy_cache_valid`
...
map $sent_http_content_type $expires {
    "text/html"                 1h; defina isto para usuas necessidades
    "text/html; charset=utf-8"  1h; defina isto para usuas necessidades
    default                     7d; defina isto para usuas necessidades
}
