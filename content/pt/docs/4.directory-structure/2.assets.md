...
O Nuxt permite você define ficheiros/módulos/bibliotecas CSS que você quiser definir globalmente (íncluido dentro de cada página). Dentro do nuxt.config você pode facilmente adicionar seus estilos usando a propriedade CSS.
