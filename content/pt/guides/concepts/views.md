...
Veja o [livro de Estrutura de Diretórios](/docs/2.x/x/directory-structure/nuxt) para saber mais sobre todas as propriedades que você pode usar em sua página
...
Saiba mais sobre o [componente Nuxt](/docs/2.x/x/features/nuxt-components) on capítulo de componentes
