...
> O Nuxt.js permite que você forneça seus próprios templates que serão renderizados com base na configuração do Nuxt. Este recurso é especialmente útil para usar com [módulos](/docs/2.x/x/directory-structure/modules).
...
> Você pode fornecer seus arquivos personalizados para observar e regenerar após as alterações. Este recurso é especialmente útil para usar com [módulos](/docs/2.x/x/directory-structure/modules).
