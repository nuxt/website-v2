...
Para adicionar fontes externas, como google fonts, confira o [capítulo Meta Tags e SEO](/docs/2.x/x/features/meta-tags-seo#external-resources)
...
Se você deseja alterar as configurações do loader, use [build.extend](/docs/2.x/x/configuration-glossary/configuration-build#extend).
