...
Saiba mais sobre a [propriedade watchQuery]((/docs/2.x/components-glossary/pages-watchquery) e veja a list das [propriedades disponíveis no context(/docs/2.x/2.x/concepts/context-helpers).
