...
Компонент `<Nuxt>` используется для отображения страничных компонентов. По сути, он заменяется внутренними компонентами страницы, в зависимости от того какая страница отображается. Поэтому компонент `<Nuxt>` необходимо добавлять в ваши макеты.
