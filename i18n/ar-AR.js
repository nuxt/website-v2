module.exports = {
  common: {
    ...
    please_define_title: 'من فظلك حدد عنوانا للصفحة الترحيبية',
    please_define_description:
      'من فظلك حدد وصفا في الصفحة الترحيبية',
    search: 'بحث ("/" لتفاصيل أكثر)',
    version: 'النسخة'
  },
  iso: 'ar',
  ...
  header: {
    ...
    search: {
      placeholder: 'بحث ("/" لتفاصيل أكثر)'
    }
  },
  homepage: {
    meta: {
      title: 'Vue اطار ويب لإنشاء الواجهات مبني على - Nuxt.js',
      description:
        '.اطار ويب مفتوح المصدر يجعل تطوير الويب بسيط وقوي .NuxtJS بكل ثقة باستعمال Vue.js ابني تطبيقك القادم من'
    },
    welcome: {
