module.exports = {
  ...
  homepage: {
    meta: {
      title: 'Nuxt.js — Интуитивно понятный фреймворк на Vue',
      description:
        'Оставьте тревоги при проектировании вашего следующего приложение на Vue.js, используя NuxtJS. Фреймворк с открытым исходным кодом, модернизирующий и упрощающий процесс разработки.'
    },
    welcome: {
      title: 'Интуитивно понятный {br} {frameworkType} фреймворк',
      description:
        'Оставьте тревоги при проектировании вашего следующего приложение на Vue.js, используя NuxtJS. {openSource} фреймворк, модернизирующий и упрощающий процесс разработки.',
    ...
    why: {
      ...
      enjoyable: {
        title: 'Удобный',
        description:
          'Наша главная цель - удобство разработчика. Мы любим Nuxt.js и постоянно улучшаем его, так что, вы тоже его полюбите! {break} В вашим услугам отличная документация, информативные описания ошибок, сбалансированные настройки по умолчанию и прочие интересные решения. А если у вас возникнут вопросы или проблемы, наше дружелюбное сообщество всегда готово помочь.'
      },
      modular: {
        title: 'Модульный',
        description:
          'Nuxt разработан на основе мощной модульной архитектуры. Более 50 разнообразных модулей сделают разработку проще и быстрее. Вам не придется изобретать велосипед, чтобы прикрутить PWA-фичи, Google Analytics или сгенерировать sitemap.'
      },
      performant: {
        title: 'Быстрый',
        description:
          'Nuxt.js оптимизирует ваше приложение сразу из коробки. Мы постоянно работаем над повышением производительности приложений, используя наработки Vue.js и Node.js. Чтобы выжать максимум из вашего приложения в Nuxt влючен анализатор статики и множество возможностей для тонкой настройки приложения.'
      }
    },
    companies: {
  ...
  'video-courses': {
    ...
    description:
      'С этими видео курсами, созданными нашим партнером VueSchool, вы можете узнать больше о фреймворке Nuxt.js.',
    cta: {
      discover: 'Изучите Mastering Nuxt',
      start: 'НАЧАТЬ КУРС'
    }
  },
  sponsor: {
    meta: {
      title: 'Поддержать разработку NuxtJS',
      description:
    ...
    pledges: {
      ...
      description:
        'Периодические пожертвования дают взамен эксклюзивные привилегии, например, вывод вашего имени в репозитории NuxtJS на GitHub, или вывод логотипа вашей компании на этом сайте. Станьте спонсором через {opencollective} (средства идут в фонд с прозрачными моделями расходов, которые поддерживают сообщество и события).'
    },
  ...
  content: {
    ...
    examples: {
      ...
      assetManagement: 'Работа со статикой',
    ...
    guides: {
      ...
      'internals-glossary': 'Под капотом',
  ...
  footer: {
    links: {
      discover: {
        title: 'Изучите',
        shop: 'Наш Goodies Store',
        consulting: 'Обучение & консультации',
        sponsorNuxt: 'Спонсорство & донаты'
      },
      about: {
        title: 'О нас',
        team: 'Наша команда',
      ...
      support: {
        title: 'Поддержка',
        resources: 'Ресурсы',
        discord: 'Общайтесь с нами',
        contributionGuide: 'Внести свой вклад'
      }
    }
  },
  cookies: {
    consent: 'Мы используем файлы Cookies для аналитики и улучшения работы страниц!',
