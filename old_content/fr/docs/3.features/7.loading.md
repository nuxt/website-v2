...
Si nous voulons nous inspirer du tourniquet de base de Nuxt, nous pouvons retrouver le code [ici](https://github.com/nuxt/nuxt/tree/2.x-dev/packages/vue-app/template/views/loading) !
