<template>
  <div>
    ...
    <p class="Contribute">Caught a mistake or want to contribute to the documentation?
      <a :href="'https://github.com/nuxt/docs/blob/master/api/index.md'" target="_blank">
...
export default {
  data ({ route, store }, callback) {
    ...
    const path = '/docs/' + store.state.lang.iso + '/' + route.params.category + '/index.md'
