    ...
    <div class="container mx-auto px-4 pt-16">
      ...
      <section class="flex flex-wrap -mx-4">
        <nuxt-link :to="{ name: 'themes' }" class="block w-full lg:w-1/2 p-4">
          <div class="block bg-surface hover:bg-gray-200 rounded p-8 text-center">
            <h2 class="text-2xl text-onSurfacePrimary font-medium uppercase mb-8">Themes</h2>
            <i-theming class="text-onSurfacePrimary inline-block w-auto h-40 sm:h-56 xl:h-64"></i-theming>
          </div>
        </nuxt-link>
        <nuxt-link :to="{ name: 'video-courses' }" class="w-full lg:w-1/2 p-4">
          <div class="block bg-surface hover:bg-gray-200 rounded p-8 text-center">
            <h2 class="text-2xl text-onSurfacePrimary font-medium uppercase mb-8">Video Courses</h2>
            <i-videos class="text-onSurfacePrimary inline-block w-auto h-40 sm:h-56 xl:h-64"></i-videos>
          </div>
        </nuxt-link>
      </section>
    </div>
