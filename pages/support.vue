  ...
  <div class="bg-elevatedSurface shadow-nuxt">
    <div class="container mx-auto px-4 pt-16 pb-12">
      <div class="flex flex-wrap justify-between mb-4">
        ...
        <i-support class="w-2/3 mx-auto lg:mx-0 lg:w-5/12 lg:-mt-8 text-elevatedSurface"/>
      </div>
      <div class="flex -mx-2 md:-mx-4 mb-4">
        <section class="w-full p-2 md:p-4">
          <div class="bg-surface p-8 rounded-lg shadow-lg w-full relative">
      ...
      <h2 class="text-3xl xl:text-4xl text-onSurfacePrimary font-medium leading-normal mb-6">
        Nuxt<span class="text-nuxt-lightgreen">JS</span> for enterprise
      </h2>
      <h3 class="xl:text-lg text-onSurfaceSecondary font-medium leading-relaxed mb-6 flex flex-wrap items-center">
